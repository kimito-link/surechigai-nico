...
function svgAvatarsTranslation() {
	...
	var text = {
		welcomeSlogan: "<h2>Please Create Your Avatar</h2>",
		...
		alertSuccessCustom: "<h3>Congratulations!</h3><p>Your new avatar is saved.</p>", // when "custom" integration is used
		...
		alertSuccessGravatar: "<h3>Congratulations!</h3><p>You have successfully changed your Gravatar. Please allow 5 to 10 minutes for avatar changes to take effect.</p>",
