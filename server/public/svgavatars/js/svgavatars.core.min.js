...
"faceshape humanbody chinshadow facehighlight ears mouth nose eyesfront".split(" ");P(d,a);break;case "ears":d="faceshape humanbody chinshadow facehighlight ears mouth nose eyesfront".split(" ");P(d,a);break;case "nose":d="faceshape humanbody chinshadow facehighlight ears mouth nose eyesfront".split(" ");P(d,a);break;default:d=[y],P(d,a)}}function ea(){G="boys"===k?{backs:"#ecf0f1",humanbody:"#f5deb3",clothes:"#386e77",hair:"#2a232b",ears:"#f5deb3",faceshape:"#f5deb3",chinshadow:"#f5deb3",facehighlight:"#f5deb3",
eyebrows:"#2a232b",eyesback:"#000000",eyesfront:"#000000",eyesiris:"#3d2b1f",glasses:"#26120B",mustache:"#2a232b",beard:"#2a232b",mouth:"#da7c87"}:{backs:"#ecf0f1",humanbody:"#fce4d6",clothes:"#09aac5",hair:"#2a232b",ears:"#fce4d6",faceshape:"#fce4d6",chinshadow:"#fce4d6",facehighlight:"#fce4d6",eyebrows:"#2a232b",eyesback:"#000000",eyesfront:"#000000",eyesiris:"#3d2b1f",glasses:"#26120B",mouth:"#f771a9"};b("#svga-svgmain").empty();q();for(var a in g)g.hasOwnProperty(a)&&(D="backs"===a||"hair"===
...
a.s+=d;0>a.s&&(a.s=0);1<a.s&&(a.s=1);a.v+=h;0>a.v&&(a.v=0);1<a.v&&(a.v=1);return Z(a).toHexString()}function I(a,d){return Math.floor(Math.random()*(d-a+1))+a}function oa(){if(0>f.zooming)for(p=-1;p>=f.zooming&&-3<=p;p--)e.get("svga-group-humanwrap").svgaScaleDown();else if(0<f.zooming)for(p=1;p<=f.zooming&&3>=p;p++)e.get("svga-group-humanwrap").svgaScaleUp()}if("boys"===k){var G={backs:"#ecf0f1",humanbody:"#f5deb3",clothes:"#386e77",hair:"#2a232b",ears:"#f5deb3",faceshape:"#f5deb3",chinshadow:"#f5deb3",
facehighlight:"#f5deb3",eyebrows:"#2a232b",eyesback:"#000000",eyesfront:"#000000",eyesiris:"#3d2b1f",glasses:"#26120B",mustache:"#2a232b",beard:"#2a232b",mouth:"#da7c87"};b("#svga-container").addClass("svga-boys")}else if("girls"===k)G={backs:"#ecf0f1",humanbody:"#fce4d6",clothes:"#09aac5",hair:"#2a232b",ears:"#fce4d6",faceshape:"#fce4d6",chinshadow:"#fce4d6",facehighlight:"#fce4d6",eyebrows:"#2a232b",eyesback:"#000000",eyesfront:"#000000",eyesiris:"#3d2b1f",glasses:"#26120B",mouth:"#f771a9"},b("#svga-container").addClass("svga-girls");
...
m.svgFormatMsg,'</li><li id="svga-png-two">',"png - "+f.pngSecondDownloadSize+"x"+f.pngSecondDownloadSize,'</li><li id="svga-png-one">',"png - "+f.pngFirstDownloadSize+"x"+f.pngFirstDownloadSize,'</li></ul></li></ul></div></div></div></div><p class="svga-credit">',m.authoredMsg,'<a href="http://svgavatars.com" target="_blank" rel="nofollow">svgAvatars.com</a></p><div id="svga-start-overlay">&nbsp;</div><div id="svga-work-overlay">&nbsp;</div><div id="svga-loader">',m.waitMsg,'</div><div id="svga-gender">',
Y,'<div id="svga-starticons-wrap"><div id="svga-start-boys"></div><div id="svga-start-girls"></div></div>',m.welcomeMsg,'</div><div id="svga-dialog">',m.confirmMsg,'<div id="svga-dialog-btns"><div id="svga-dialog-ok">',m.okMsg,'</div><div id="svga-dialog-cancel">',m.cancelMsg,'</div></div></div><div id="svga-gravatar">',m.gravatarTitle,'<div id="svga-gravatar-fields"><input class="svga-input" type="text" id="svga-gravatar-email" value="" placeholder="',m.gravatarEmail,'"><input class="svga-input" type="password" id="svga-gravatar-pass" value="" placeholder="',
m.gravatarPwd,'"><p>',m.gravatarRating,'<label class="svga-gr-rating"><input type="radio" name="svga-gr-rating" value="0" checked> G</label><label class="svga-gr-rating"><input type="radio" name="svga-gr-rating" value="1"> PG</label><label class="svga-gr-rating"><input type="radio" name="svga-gr-rating" value="2"> R</label><label class="svga-gr-rating"><input type="radio" name="svga-gr-rating" value="3"> X</label></p></div>',m.gravatarNote,'<div id="svga-gravatar-btns"><div id="svga-gravatar-ok">',
m.installMsg,'</div><div id="svga-gravatar-cancel">',m.cancelMsg,'</div></div></div><div id="svga-message"><div id="svga-message-text"></div><div class="svga-close">',m.closeMsg,'</div></div><div id="svga-gravatar-message"><div id="svga-gravatar-message-text"></div><div id="svga-tryagain">',m.tryAgainMsg,'</div></div><div id="svga-ios"><div id="svga-ios-text">',m.iosMsg,'</div><div id="svga-ios-image"></div><div class="svga-close">',m.closeMsg,'</div></div><div id="svga-share-block"><div id="svga-share-image"></div><ul><li id="svga-share-twitter"><a href="#"><span id="svga-twitter-icon"></span></a></li><li id="svga-share-pinterest"><a href="#"><span id="svga-pinterest-icon"></span></a></li></ul><div class="svga-close">',
m.closeMsg,"</div></div></div>"].join("");e.supported||(Y=['<div id="svga-container" class="svga-no-touch"><h3 class="svga-nosvg">',m.alertSvgSupportError,"</h3></div>"].join(""));b("#svgAvatars").empty().html(Y);switch(f.colorScheme){case "light":b("#svga-container").addClass("svga-light");break;case "dark":b("#svga-container").addClass("svga-dark");break;case "custom":b("#svga-container").addClass("svga-custom");break;default:b("#svga-container").addClass("svga-light")}e.supported&&(b("#svga-canvas").attr({width:200,
height:200}),"none"===f.integration&&b("#svga-saveavatar").remove(),f.hideShareButton&&b("#svga-shareavatar").remove(),f.hideSvgDownloadButton&&f.hidePngFirstDownloadButton&&f.hidePngSecondDownloadButton?b("#svga-downloadavatar").remove():(f.hidePngFirstDownloadButton&&b("#svga-png-one").remove(),f.hidePngSecondDownloadButton&&b("#svga-png-two").remove(),f.hideSvgDownloadButton&&b("#svga-svgfile").remove()),f.hideGravatar&&b("#svga-gravataravatar").remove(),f.twitter||b("#svga-share-twitter").remove(),
f.pinterest||b("#svga-share-pinterest").remove(),f.twitter||f.pinterest||b("#svga-shareavatar").remove(),sa&&(b("#svga-container").removeClass("svga-no-touch"),b("#svga-downloadavatar > ul").remove()),Ba&&f.hideSvgDownloadOnAndroid&&b("#svga-svgfile").remove(),Ca&&b("#svga-container").addClass("svga-opera"),ta&&(b("#svga-container").addClass("svga-win8tablet"),b("#svga-downloadavatar > ul").remove()),b("#svga-start-boys").append('<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="80px" height="80px" viewBox="0 0 80 80"><path class="svga-icon-boy" d="M73.22,72.6c-1.05-6.99-8.49-9.28-14.35-10.97c-3.07-0.89-6.98-1.58-9.48-3.72C47.3,56.13,47.5,50.9,49,49.8c3.27-2.39,5.26-7.51,6.14-11.25c0.25-1.07-0.36-0.46,0.81-0.64c0.71-0.11,2.13-2.3,2.64-3.21c1.02-1.83,2.41-4.85,2.42-8.02c0.01-2.23-1.09-2.51-2.41-2.29c-0.43,0.07-0.93,0.21-0.93,0.21c1.42-1.84,1.71-8.22-0.67-13.4C53.56,3.71,44.38,2,40,2c-2.35,0-7.61,1.63-7.81,3.31c-3.37,0.19-7.7,2.55-9.2,5.89c-2.41,5.38-1.48,11.4-0.68,13.4c0,0-0.5-0.14-0.93-0.21c-1.32-0.21-2.42,0.07-2.41,2.29c0.01,3.16,1.41,6.19,2.43,8.02c0.51,0.91,1.93,3.1,2.64,3.21c1.17,0.18,0.56-0.42,0.81,0.64c0.89,3.74,3.09,9.03,6.14,11.25c1.69,2.04,1.7,6.33-0.39,8.11c-2.84,2.43-7.37,3.07-10.84,4.12c-5.86,1.77-13.29,4.9-13.27,12.25C6.51,76.73,7.7,78,10.13,78h59.74c2.43,0,3.68-1.27,3.63-3.72C73.5,74.28,73.4,73.81,73.22,72.6C72.63,68.73,73.4,73.81,73.22,72.6z"/></svg>'),
