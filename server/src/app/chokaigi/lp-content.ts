...
export const YUKKURI_MAIN_SCRIPT: ReadonlyArray<{
  ...
  {
    speaker: "tanunee",
    text: "連絡はXでやるとしても、相手の迷惑にならない範囲が大前提よ。ブロックや通報、オプトアウトの話は、本番公開のときにちゃんと画面に出すわ。ここでは方針だけ掴んでおいて。",
  },
  {
    speaker: "rink",
...
export const USAGE_STEPS = [
  ...
  "すれ違いが検出されると、同じ会場の空気を共有しているニコニコユーザーとマッチする想定です。",
  "本サイト内でメッセージ機能は提供しません。実際の連絡はXアカウント同士で行ってください。",
