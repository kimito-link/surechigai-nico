...
export const SPECIAL_THANKS_PROFILES: ReadonlyArray<SpecialThanksProfile> = [
  ...
  },
  {
    ...
    intro: [
      ...
      "インターネットの掲示板まわりは、ひとによっては悪口や冷たい書き込みがつきものな場所も多いのですが、オオマユさんのスレでは応援や温かい反応が目立つ——『人柄がよくて、自然と応援したくなる魅力的な人』だからこそ、そういう空気が生まれているのだと思います。ゆっくり解説の動画も作らせていただきました。下のリンクから、活動のほうもぜひ覗いてみてください。",
    ],
    sites: [
      {
        label: "ニコニコ生放送（コミュニティ）",
        href: "https://cas.nicovideo.jp/user/87585927",
        tagline: "配信・アーカイブはこちらから",
      },
    ],
  ...
  },
  {
    ...
    intro: [
      ...
      "かわいい衣装でコスプレしているときはアイドル配信のような華やかさ、部屋着にメガネのときは素のキャラが前面に出る——など、見せ方のギャップも楽しめるのが魅力です。コミュニティ『まぁるの農園』でも配信されています。ゆっくり紹介動画も作らせていただきました。下のリンクから、ぜひ本人の空気感を覗いてみてください。",
    ],
    sites: [
      {
        label: "ニコニココミュニティ「まぁるの農園」",
        href: "https://com.nicovideo.jp/community/co5336189",
        tagline: "配信・コミュニティページ",
      },
    ],
    xHandles: [
      { label: "@m20210411", href: "https://x.com/m20210411" },
      { label: "@m20220215（サブ）", href: "https://x.com/m20220215" },
    ],
  },
  {
    id: "miidesu",
